...
export const Latency = ({ value, settings, setSettings, t }) => {
  const showLatency = settings.showLatency ?? true;
  return (
    <div className={`flex gap-2 absolute text-[normal] right-2.5 top-2.5`}>
      ...
      <SettingsButton settings={settings} onSettingsChange={setSettings} t={t} />
    </div>
  );
};
